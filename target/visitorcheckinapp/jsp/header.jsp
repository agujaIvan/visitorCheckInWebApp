            ...
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="text-white dropdown-item display-4" href="${pageContext.request.contextPath}/AddUserServlet">Add user<br></a>
                        <a class="text-white dropdown-item display-4" href="${pageContext.request.contextPath}/CreateLessonServlet">Create class<br></a>
                        <a class="text-white dropdown-item display-4" href="${pageContext.request.contextPath}/jsp/danceStyle.jsp">add dance style<br></a>
                        ...
                        <a class="text-white dropdown-item display-4" href="${pageContext.request.contextPath}/jsp/adminPortal.jsp">Administrator<br></a>
                    </div>
                </li>
            </ul>
