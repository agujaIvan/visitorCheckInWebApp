    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item mr-4">
                <a class="nav-link text-white" href="${pageContext.request.contextPath}/LogOutServlet">Sign Out</a>
                    <!--<img class= "rounded-circle" src="${pageContext.request.contextPath}/images/img_user.png"
                         width="40" id="myImg"/>-->
            </li>
        </ul>
        <div class="btn-group">
